...
class Dog(models.Model):
    ...
    chip_number = models.IntegerField(blank=True, verbose_name=_('מספר שבב'))
    ...
    next_treatment_rabbies = models.DateField(blank=True, null=True, verbose_name=_('כלבת - תאריך הטיפול הבא'))
